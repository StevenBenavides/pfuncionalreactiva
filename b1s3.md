...
```Scala
//funcion para determinar el area de una figura
//funcion general
def calcArea(f : ( Double, Double ) => Double, a: Double, b: Double ) = f(a, b)

//funciones anonimas para las diferentes areas
val areaTriangle= ( a: Double, b : Double) => a + b / 2
val areaParalelogramo = ( a: Double, b : Double) => a * b
val areaRectangulo = ( a: Double, b : Double) => a * b
val areaRombo = ( a: Double, b : Double) => a * b / 2

//ingreso de los datos
calcArea(areaParalelogramo,3,2);
calcArea(areaTriangle, 3, 4);
calcArea(areaRectangulo, 4,3);
calcArea(areaRombo, 9,7);
